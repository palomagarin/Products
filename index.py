...
class Product:
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = '{} agregado exitosamente'.format(self.name.get())
    ...
    def delete_product(self):
        ...
        self.message['text'] = '{} eliminado correctamente'.format(name)
        self.get_products()
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = '{} actualizado con éxito'.format(name)
        self.get_products()
